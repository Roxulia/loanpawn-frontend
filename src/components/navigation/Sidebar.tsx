...
const navigationGroups: NavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Collateral",
        to: routePaths.collateral,
        icon: "collateral",
        permissions: ["list_collateral", "delete_collateral"],
      },
      {
        label: "Loan Slips",
        to: routePaths.slips,
      ...
      },
      {
        ...
        to: routePaths.interest,
        icon: "interest",
        permissions: ["list_loan_contract", "create_loan_contract"],
      },
      {
        label: "Redemptions",
        to: routePaths.redemptions,
        icon: "redemptions",
        permissions: ["list_loan_contract", "create_loan_contract"],
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: "currency",
        permissions: ["list_currency"],
        features: ["currency_management"],
      },
      {
        label: "Exchange Pairs",
        to: routePaths.exchangePairs,
        icon: "currency",
        permissions: ["list_exchange_pair"],
        features: ["currency_management", "exchange_pair_management"],
      },
      {
        label: "Daily Rates",
        to: routePaths.dailyRates,
        icon: "currency",
        permissions: ["list_exchange_rate"],
        features: [
          "currency_management",
      ...
      },
      {
        ...
        to: routePaths.financialAccounts,
        icon: "financialAccounts",
      ...
      },
      {
        ...
        to: routePaths.debts,
        icon: "debts",
        permissions: ["list_debt", "create_debt", "update_debt", "delete_debt"],
      },
      {
        label: "Business Loans",
        to: routePaths.businessLoans,
        icon: "businessLoans",
        permissions: [
          "list_business_loan",
        ...
        features: ["business_loan_management"],
      },
      {
        label: "Lenders",
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          {
            label: "Personal",
            to: routePaths.settingsPersonal,
            permissions: [
              "manage_slip_document",
              "manage_tenant_timezone",
              "manage_tenant_contact",
          ...
          {
            label: "Default Data",
            to: routePaths.settingsDefaultData,
            permissions: [
              "list_material_type",
              "list_interest_type",
              "list_item_category_type",
          ...
          {
            label: "Documents",
            to: routePaths.settingsDocuments,
            permissions: ["manage_slip_document"],
            features: ["slip_document_layout_management"],
          },
        ],
      },
    ],
      ...
      items: group.items
        .filter(
          (item) =>
            ...
            (!item.features || hasAllEnabledFeatures(item.features)),
        )
        .map((item) => ({
          ...item,
          children: item.children?.filter(
            (child) =>
              ...
              (!child.features || hasAllEnabledFeatures(child.features)),
          ),
        })),
    }))
            ...
            <div className="nav-group" key={group.label}>
              ...
              <div className="nav-list">
                {group.items.map((item) => {
                  ...
                  return (
                    <div className="nav-item-with-children" key={item.to}>
                      <NavLink
                        className={
                          isSectionActive
                            ? "nav-parent-link nav-parent-link--active"
                            : "nav-parent-link"
                        }
                        to={item.to}
                        onClick={onNavigate}
...
function SidebarIcon({ name }: { name: IconName }) {
  const paths: Record<IconName, string[]> = {
    ...
    currency: [
      ...
      "M2 12h20",
      "M12 2c3 3 4 7 4 10s-1 7-4 10c-3-3-4-7-4-10s1-7 4-10Z",
    ],
    financialAccounts: [
      "M3 6h18v14H3V6Z",
      "M3 10h18",
