...
export function ArrowRightIcon() {
  return (
    <svg
      aria-hidden="true"
      className="interest-accrual-mobile-row__arrow"
      viewBox="0 0 24 24"
    >
      <path d="M5 12h14" />
...
export function VaultIcon() {
  return (
    <svg
      aria-hidden="true"
      className="accounting-serene-icon"
      viewBox="0 0 24 24"
    >
...
export function CheckIcon() {
  return (
    <svg
      aria-hidden="true"
      className="accounting-serene-check"
      viewBox="0 0 24 24"
    >
...
export function RefreshIcon() {
  return (
    <svg
      aria-hidden="true"
      className="customer-serene-refresh__icon"
      viewBox="0 0 24 24"
    >
      <path d="M20 6v5h-5" />
      <path d="M4 18v-5h5" />
...
export function LocationPinIcon() {
  return (
    <svg
      aria-hidden="true"
      className="customer-serene-location__icon"
      viewBox="0 0 24 24"
    >
...
export function ClockIcon() {
  return (
    <svg
      aria-hidden="true"
      className="customer-record-card__meta-icon"
      viewBox="0 0 24 24"
    >
...
export function ChevronRightIcon() {
  return (
    <svg
      aria-hidden="true"
      className="customer-record-card__chevron"
      viewBox="0 0 24 24"
    >
...
export function ContactPageIcon() {
  return (
    <svg
      aria-hidden="true"
      className="customer-detail-panel__icon"
      viewBox="0 0 24 24"
    >
      <path d="M7 3h8l4 4v14H7V3Z" />
      <path d="M15 3v5h4" />
      <path d="M10 13a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z" />
      <path d="M6 17c1-1.5 2.3-2.2 4-2.2s3 .7 4 2.2" />
    </svg>
  );
}
...
export function ActiveSlipIcon() {
  return (
    <svg
      aria-hidden="true"
      className="customer-detail-panel__icon"
