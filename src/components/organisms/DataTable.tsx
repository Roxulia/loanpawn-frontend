...
export function DataTable<TItem>({
  ...
  return (
    <div
      className={
        onRowClick ? "ui-data-table ui-data-table--clickable" : "ui-data-table"
      }
    >
            ...
            if (renderMobileCard) {
              return (
                <div key={getItemId(item)}>
                  {renderMobileCard(item, itemActions)}
                </div>
              );
            }
      ...
      {pagination && (
        <div className="ui-pagination">
          <span className="ui-pagination__meta">
            {t(
              `Page ${pagination.currentPage} of ${pagination.lastPage}${pagination.total !== undefined ? ` - ${pagination.total} records` : ""}`,
            )}
          </span>
          <Button
