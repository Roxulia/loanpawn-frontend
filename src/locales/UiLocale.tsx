...
const mmTranslations: Record<string, string> = {
  ...
  'No financial accounts are available.': 'အသုံးပြုနိုင်သော ငွေစာရင်းအကောင့် မရှိပါ။',
  'No financial accounts match your search.': 'ရှာဖွေမှုနှင့် ကိုက်ညီသော ငွေစာရင်းအကောင့် မရှိပါ။',
  'Account name, code, or currency': 'အကောင့်အမည်၊ ကုဒ် သို့မဟုတ် ငွေကြေးအမျိုးအစား',
  Account: 'အကောင့်',
  ...
  'Owner account access is managed automatically and cannot be changed.': 'ပိုင်ရှင်၏ အကောင့်အသုံးပြုခွင့်ကို စနစ်က အလိုအလျောက် စီမံထားပြီး ပြောင်းလဲ၍ မရပါ။',
  'You cannot change your own financial account access.': 'မိမိ၏ ငွေစာရင်းအကောင့်အသုံးပြုခွင့်ကို မိမိကိုယ်တိုင် ပြောင်းလဲ၍ မရပါ။',
  'Activate this staff account before assigning financial accounts.': 'ငွေစာရင်းအကောင့်အသုံးပြုခွင့် မပေးမီ ဤဝန်ထမ်းအကောင့်ကို အသုံးပြုနိုင်အောင် ဖွင့်ပါ။',
