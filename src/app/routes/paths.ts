export const routePaths = {
  ...
  slipsForCustomer: (customerCode: string) =>
    `/slips?customer=${encodeURIComponent(customerCode)}`,
  ...
  financialAccountDetail: (accountCode: string) =>
    `/financial-accounts/${accountCode}`,
  financialAccountEdit: (accountCode: string) =>
    `/financial-accounts/${accountCode}/edit`,
  capitals: "/capitals",
  capitalCreate: "/capitals/create",
  capitalEdit: (capitalCode: string) =>
    `/capitals/${encodeURIComponent(capitalCode)}/edit`,
  expenses: "/expenses",
  expenseCreate: "/expenses/create",
  expenseEdit: (expenseCode: string) =>
    `/expenses/${encodeURIComponent(expenseCode)}/edit`,
  scheduledExpenses: "/expenses/scheduled",
  scheduledExpenseCreate: "/expenses/scheduled/create",
  scheduledExpenseDetail: (code: string) => `/expenses/scheduled/${encodeURIComponent(code)}`,
  scheduledExpenseEdit: (code: string) => `/expenses/scheduled/${encodeURIComponent(code)}/edit`,
  debts: "/debts",
  ...
  businessLoanDetail: (code: string) =>
    `/business-loans/${encodeURIComponent(code)}`,
  businessLoanEdit: (code: string) =>
    `/business-loans/${encodeURIComponent(code)}/edit`,
  businessLoanPayment: (code: string) =>
    `/business-loans/${encodeURIComponent(code)}/payment`,
  lenders: "/lenders",
  lenderCreate: "/lenders/create",
  lenderDetail: (code: string) => `/lenders/${encodeURIComponent(code)}`,
  lenderEdit: (code: string) => `/lenders/${encodeURIComponent(code)}/edit`,
  staff: "/staff",
