...
import { BusinessLoanCreatePage, BusinessLoanDetailPage, BusinessLoanListPage, BusinessLoanPaymentPage, BusinessLoanUpdatePage } from '../../modules/businessLoans'
import { LenderCreatePage, LenderDetailPage, LenderListPage, LenderUpdatePage } from '../../modules/lenders'
...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: routePaths.businessLoans, element: featureGate('business_loan_management', 'Business Loans', <PermissionRoute any={['list_business_loan', 'create_business_loan', 'update_business_loan', 'delete_business_loan']}><BusinessLoanListPage /></PermissionRoute>) },
      { path: routePaths.businessLoanCreate, element: featureGate('business_loan_management', 'Business Loans', <PermissionRoute permission="create_business_loan"><BusinessLoanCreatePage /></PermissionRoute>) },
      { path: '/business-loans/:loanCode', element: featureGate('business_loan_management', 'Business Loans', <PermissionRoute permission="list_business_loan"><BusinessLoanDetailPage /></PermissionRoute>) },
      { path: '/business-loans/:loanCode/edit', element: featureGate('business_loan_management', 'Business Loans', <PermissionRoute permission="update_business_loan"><BusinessLoanUpdatePage /></PermissionRoute>) },
      { path: '/business-loans/:loanCode/payment', element: featureGate('business_loan_management', 'Business Loans', <PermissionRoute permission="update_business_loan"><BusinessLoanPaymentPage /></PermissionRoute>) },
      { path: routePaths.lenders, element: featureGate('lender_management', 'Lenders', <PermissionRoute any={['list_lender', 'create_lender', 'update_lender', 'delete_lender']}><LenderListPage /></PermissionRoute>) },
      { path: routePaths.lenderCreate, element: featureGate('lender_management', 'Lenders', <PermissionRoute permission="create_lender"><LenderCreatePage /></PermissionRoute>) },
      { path: '/lenders/:lenderCode', element: featureGate('lender_management', 'Lenders', <PermissionRoute permission="list_lender"><LenderDetailPage /></PermissionRoute>) },
      { path: '/lenders/:lenderCode/edit', element: featureGate('lender_management', 'Lenders', <PermissionRoute permission="update_lender"><LenderUpdatePage /></PermissionRoute>) },
      ...
      { path: routePaths.settings, element: <PermissionRoute any={['manage_slip_document', 'manage_tenant_timezone', 'manage_tenant_contact', 'update_business_loan', 'update_default_currency', 'update_reporting_currency', 'update_default_financial_unit', 'manage_accounting_day_schedule', 'manage_interest_process_settings', 'list_currency', 'list_financial_account_type', 'list_material_type', 'list_interest_type', 'list_item_category_type', 'list_expense_type']}><Navigate to={routePaths.settingsPersonal} replace /></PermissionRoute> },
      { path: routePaths.settingsPersonal, element: <PermissionRoute any={['manage_slip_document', 'manage_tenant_timezone', 'manage_tenant_contact', 'update_business_loan', 'update_default_currency', 'update_reporting_currency', 'update_default_financial_unit', 'manage_accounting_day_schedule', 'manage_interest_process_settings', 'list_currency', 'list_financial_account_type', 'list_material_type', 'list_interest_type', 'list_item_category_type', 'list_expense_type']}><PersonalSettingsPage /></PermissionRoute> },
      { path: routePaths.settingsTenant, element: <PermissionRoute any={['manage_slip_document', 'manage_tenant_timezone', 'manage_tenant_contact', 'update_business_loan']}><TenantSettingsPage /></PermissionRoute> },
      ...
      { path: routePaths.settings, element: <PermissionRoute any={['manage_slip_document', 'manage_tenant_timezone', 'manage_tenant_contact', 'manage_debt_settings', 'update_business_loan', 'update_default_currency', 'update_reporting_currency', 'update_default_financial_unit', 'manage_accounting_day_schedule', 'list_currency', 'list_financial_account_type', 'list_material_type', 'list_interest_type', 'list_item_category_type', 'list_expense_type']}><Navigate to={routePaths.settingsPersonal} replace /></PermissionRoute> },
      { path: routePaths.settingsPersonal, element: <PermissionRoute any={['manage_slip_document', 'manage_tenant_timezone', 'manage_tenant_contact', 'manage_debt_settings', 'update_business_loan', 'update_default_currency', 'update_reporting_currency', 'update_default_financial_unit', 'manage_accounting_day_schedule', 'list_currency', 'list_financial_account_type', 'list_material_type', 'list_interest_type', 'list_item_category_type', 'list_expense_type']}><PersonalSettingsPage /></PermissionRoute> },
      { path: routePaths.settingsTenant, element: <PermissionRoute any={['manage_slip_document', 'manage_tenant_timezone', 'manage_tenant_contact', 'manage_debt_settings', 'update_business_loan']}><TenantSettingsPage /></PermissionRoute> },
      ...
      ...moduleRegistry.filter((module) => !['customers', 'collateral', 'staff', 'accounting', 'capitals', 'expenses', 'debts', 'business-loans', 'lenders', 'slips', 'interest', 'redemptions', 'settings'].includes(module.id)).map((module) => ({
