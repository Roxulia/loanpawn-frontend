  ...
  return (
    <section className="page">
      <SectionHeader
        ...
        action={
          <Button
            onClick={() => navigate(routePaths.slips)}
            variant="secondary"
          >
            Back
          </Button>
      ...
      {isLoading ? (
        ...
        <div className="workflow-stack">
            ...
            <KeyValueList
              items={[
                ...
                },
                {
                  ...
                  value: getCompoundScheduleEnabled(slip)
          ...
          {(canCompoundInterest ||
            ...
            <Card
              title="Advanced Interest Process"
              description="Manage principal and interest compounding for this slip."
            >
              <div className="workflow-stack">
                    ...
                    <FormGroup columns={2}>
                      ...
                      >
                        <FinancialAccountSelect
                          id="slip-partial-principal-account"
                          matchAccountId={
                            slip.account_id ?? slip.accountId ?? null
                          }
          ...
          <Card
            ...
            description={`${(slip.items ?? []).length} item${(slip.items ?? []).length === 1 ? "" : "s"}`}
          >
            {(slip.items ?? []).length === 0 ? (
              <p className="muted">
