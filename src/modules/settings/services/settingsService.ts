...
export const settingsService = {
  ...
  getDefaultDataBootstrap() {
    return apiClient.get<DefaultDataSettingsBootstrap>(
      "/tenant/settings/default-data",
    );
  },
  getSettings() {
  ...
  updateBranding(payload: BrandingSettings) {
    return apiClient.put<BrandingSettings>(
  ...
  updateDefaultUserPassword(payload: {
    default_tenant_user_password: string;
    update_key?: number;
  }) {
    return apiClient.put<TenantSettings>(
  ...
  updateDebtPaymentPolicy(payload: DebtPaymentPolicy) {
    return apiClient.put<DebtPaymentPolicy>(
      "/tenant/settings/debt-payment-policy",
      payload,
    );
  },
  ...
  updateBusinessLoanPaymentPolicy(payload: DebtPaymentPolicy) {
    return apiClient.put<DebtPaymentPolicy>(
      "/tenant/settings/business-loan-payment-policy",
      payload,
    );
  },

  getTimezone() {
    return apiClient.get<TimezoneSetting>("/tenant/settings/timezone");
  },
  listTimezoneOptions() {
    return apiClient.get<string[]>("/tenant/settings/timezone-options");
  },
  updateTimezone(payload: { timezone: string; update_key: number }) {
    return apiClient.put<TimezoneSetting>("/tenant/settings/timezone", payload);
  },
  getCurrencyPreferences() {
    return apiClient.get<CurrencyPreferences>("/tenant/settings/currencies");
  },
  updateCurrencyPreferences(payload: {
    default_currency_id: number;
    reporting_currency_id: number;
    default_financial_unit: FinancialUnitCode | null;
    update_key: number;
  }) {
    return apiClient.put<CurrencyPreferences>(
      "/tenant/settings/currencies",
      payload,
    );
  },
  getInterestProcessSettings() {
    return apiClient.get<InterestProcessSettings>(
      "/tenant/settings/interest-process",
    );
  },
  updateInterestProcessSettings(payload: {
    compounding_enabled: boolean;
    partial_principal_collection_enabled: boolean;
    update_key: number;
  }) {
    return apiClient.put<InterestProcessSettings>(
      "/tenant/settings/interest-process",
      payload,
    );
  },
  getLoanSlipCreationSettings() {
    return apiClient.get<LoanSlipCreationSettings>(
      "/tenant/settings/loan-slip-creation",
    );
  },
  updateLoanSlipCreationSettings(payload: {
    customer_info_required: boolean;
    update_key: number;
  }) {
    return apiClient.put<LoanSlipCreationSettings>(
      "/tenant/settings/loan-slip-creation",
      payload,
    );
  },
  abortReportingCurrencyChange(payload: {
    recalculation_id: number;
    update_key: number;
  }) {
    return apiClient.post<CurrencyPreferences>(
      "/tenant/settings/reporting-currency-recalculation/abort",
      payload,
    );
  },
  getAccountingDaySchedule() {
    return apiClient.get<AccountingDaySchedule>(
      "/tenant/accounting-days/schedule",
    );
  },
  updateAccountingDaySchedule(days: AccountingDaySchedule["days"]) {
  ...
  listCurrencyOptions() {
    return apiClient.get<CurrencyPage>("/tenant/currencies", {
      params: { per_page: 100 },
    });
  },
  ...
  changeLanguage(payload: ChangeLanguagePayload) {
    ...
    return apiClient.put<ChangeLanguageResponse>(
      "tenant/me/change-language",
      payload,
    );
  },
  ...
  updateSlipLayouts(payload: {
    slip_header_layout?: SlipDocumentLayout;
    slip_footer_layout?: SlipDocumentLayout;
    update_key?: number;
  }) {
    return apiClient.put<SlipLayoutSettings>(
  ...
  previewDummySlipDocument(slipNo: string, paperType = "A4") {
    return apiClient.get<string>(
      `/tenant/loan-contract-slips/${encodeURIComponent(slipNo)}/document/preview`,
      {
        params: {
  ...
  listInterestTypes(params: { page?: number; perPage?: number } = {}) {
    return apiClient.get<DefaultTypeListPage>(
      defaultTypeListPath("/tenant/interest-types/paginated", params),
    );
  },

  listExpenseTypes(params: { page?: number; perPage?: number } = {}) {
    return apiClient.get<DefaultTypeListPage>(
      defaultTypeListPath("/tenant/expense-types/paginated", params),
    );
  },

  listMaterialTypes(params: { page?: number; perPage?: number } = {}) {
    return apiClient.get<DefaultTypeListPage>(
      defaultTypeListPath("/tenant/material-types/paginated", params),
    );
  },

  listItemCategoryTypes(params: { page?: number; perPage?: number } = {}) {
    return apiClient.get<DefaultTypeListPage>(
      defaultTypeListPath("/tenant/item-category-types/paginated", params),
    );
  },

  listFinancialAccountTypes(params: { page?: number; perPage?: number } = {}) {
    return apiClient.get<DefaultTypeListPage>(
      defaultTypeListPath("/tenant/financial-account-types", params),
    );
  },
  ...
  createItemCategoryType(payload: { name: string; code: string }) {
    return apiClient.post<DefaultTypeOption>(
      "/tenant/item-category-types",
      payload,
    );
  },
  ...
  createFinancialAccountType(payload: { name: string; code: string }) {
    return apiClient.post<DefaultTypeOption>(
      "/tenant/financial-account-types",
      payload,
    );
  },
  ...
  updateFinancialAccountType(
    currentCode: string,
    payload: { name: string; code: string; update_key: number },
  ) {
    return apiClient.put<DefaultTypeOption>(
      `/tenant/financial-account-types/${encodeURIComponent(currentCode)}`,
      payload,
    );
  },
  ...
  deleteInterestType(code: string) {
    return apiClient.delete<{ message: string }>(
      `/tenant/interest-types/${encodeURIComponent(code)}`,
    );
  },

  deleteExpenseType(code: string) {
    return apiClient.delete<{ message: string }>(
      `/tenant/expense-types/${encodeURIComponent(code)}`,
    );
  },

  deleteMaterialType(code: string) {
    return apiClient.delete<{ message: string }>(
      `/tenant/material-types/${encodeURIComponent(code)}`,
    );
  },

  deleteItemCategoryType(code: string) {
    return apiClient.delete<{ message: string }>(
      `/tenant/item-category-types/${encodeURIComponent(code)}`,
    );
  },

  deleteFinancialAccountType(code: string) {
    return apiClient.delete<{ message: string }>(
      `/tenant/financial-account-types/${encodeURIComponent(code)}`,
    );
  },
};
