...
export const moduleRegistry: ModuleDefinition[] = [
  {
    ...
    description:
      "Customer search, identity details, and soft-delete lifecycle.",
  ...
  },
  {
    ...
    description:
      "Jewellery and normal collateral item lookup and status tracking.",
  ...
  },
  {
    ...
    serverModule: "PawnModule",
    description:
      "Pawn contract creation, lookup, document preview, and history.",
  ...
  },
  {
    ...
    serverModule: "PawnModule",
    description:
      "Interest calculation, payment posting, and unpaid debt handling.",
    listPermission: "list_loan_contract",
  ...
  },
  {
    ...
    serverModule: "PawnModule",
    description:
      "Redeem calculation, collateral release, and redemption records.",
    listPermission: "list_loan_contract",
    modulePermissions: ["list_loan_contract", "create_loan_contract"],
  },
  {
    ...
    serverModule: "TenantModule",
    description:
      "Income and expense ledger entries created by financial operations.",
  ...
  },
  {
    ...
    serverModule: "TenantModule",
    description:
      "Shop capital recording with incoming accounting transaction support.",
  ...
  },
  {
    ...
    routeSegment: "business-loans",
    apiBasePath: "/tenant/business-loans",
    serverModule: "TenantModule",
    description:
      "Lender funding, liability balances, interest expense, and repayments.",
    listPermission: "list_business_loan",
    modulePermissions: [
      "list_business_loan",
  ...
  },
  {
    id: "lenders",
    label: "Lenders",
    routeSegment: "lenders",
    apiBasePath: "/tenant/lenders",
    serverModule: "TenantModule",
    description: "Shared lender identities and their business loan history.",
    listPermission: "list_lender",
    modulePermissions: [
      "list_lender",
      "create_lender",
      "update_lender",
  ...
  },
  {
    ...
    serverModule: "TenantModule",
    description:
      "Tenant configuration, branding, and slip document layout controls.",
