...
type ExpenseFormProps = {
  ...
  isSaving: boolean;
  onCancel: () => void;
  onChange: <TField extends keyof ExpenseFormState>(
    field: TField,
    value: ExpenseFormState[TField],
  ) => void;
      ...
      <form className="ui-form" onSubmit={onSubmit}>
        <FormGroup columns={2}>
          ...
          <FormField
            ...
            helperText={
              editing
                ? "The posted expense amount cannot be changed."
                : undefined
            }
          ...
          >
            <Select
              ...
              id="expense-create-type-id"
              onChange={(event) =>
                onChange("expense_type_id", event.target.value)
              }
          ...
          >
            <ExpenseImageInput
              ...
              onRemoveChange={(removed) =>
                onChange("remove_image_reference", removed)
              }
            />
          </FormField>
        </FormGroup>
