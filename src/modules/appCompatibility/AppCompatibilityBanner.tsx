...
function DesktopAppCompatibilityBanner(props: BannerProps) {
  return (
    <CompatibilityBannerContent
      className="app-compatibility-banner--desktop"
      {...props}
    />
  );
}
...
function MobileAppCompatibilityBanner(props: BannerProps) {
  return (
    <CompatibilityBannerContent
      className="app-compatibility-banner--mobile"
      {...props}
    />
  );
}

function CompatibilityBannerContent({
  className,
  installedVersion,
  ...
  return (
    <section className={`app-compatibility-banner ${className}`} role="status">
      ...
      {status !== "checking" && (
        <Button
          onClick={onAction}
          variant={isUnsupported ? "primary" : "secondary"}
        >
...
async function retryCompatibilityCheck() {
  compatibilityStore.setState({
    ...
    minimumSupportedVersion:
      compatibilityStore.getSnapshot().minimumSupportedVersion,
    status: "checking",
  });
