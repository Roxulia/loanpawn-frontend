...
export type ExchangeRateState = {
  ...
  latest_entry: ExchangeRateEntry | null;
};
export type ExchangeRateTrendPoint = {
  date: string;
  buying_close: string;
  selling_close: string;
};
export type ExchangeRateTrend = {
  pair_code: string;
  from_date: string;
  to_date: string;
  tenant_points: ExchangeRateTrendPoint[];
  platform_points: ExchangeRateTrendPoint[];
};
