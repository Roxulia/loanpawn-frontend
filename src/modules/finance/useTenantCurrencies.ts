...
export function useTenantCurrencies() {
  ...
  return {
    ...
    effectiveReportingCurrencyId:
      settings?.effective_reporting_currency_id ??
      settings?.reporting_currency_id ??
      null,
    effectiveReportingCurrencySymbol:
      settings?.effective_reporting_currency_symbol ??
      settings?.reporting_currency_symbol ??
      "",
    reportingCurrencyRecalculation:
      settings?.reporting_currency_recalculation ?? null,
